...
insert  into `blood_alert`(`id`,`hsp_id`,`blood_type`,`contact`,`desc`,`donor_name`,`donor_mobile`,`status`) values (1,'6','A+','09493040484','hi','streamway','09493040484','Approved');
...
insert  into `donation_request`(`id`,`hsp`,`name`,`email`,`disease`,`blood_type`,`b_unites`,`r_date`,`status`,`age`) values (1,'5','streamway','streamwaytechnologiespvtltd@gmail.com','Nothing','A+','5','2025-02-20','Approved','23'),(2,'5','streamway','streamwaytechnologiespvtltd@gmail.com','Nothing','A+','4','2025-03-07','Approved','27'),(3,'6','kishan','kishan@gmail.com','Nothing','B+','3','2025-03-08','Approved','34');
...
insert  into `donor`(`id`,`f_name`,`email`,`mobile`,`password`,`otp`,`blood_type`,`address`,`status`) values (3,'streamway','streamwaytechnologiespvtltd@gmail.com','09493040484','123','754660','A+','hyderabad','Verified'),(7,'kishan','gkvtechsolutions@gmail.com','01234567890','123','775570','A+','hyderabad','Verified');
...
insert  into `hospital`(`id`,`name`,`contact`,`email`,`address`,`password`) values (5,'Apolo','1234567890','GKVTECHSOLUTIONS@gmail.com','hyderabad','GPEWUM'),(6,'Gandhi','09493040484','streamwaytechnologiespvtltd@gmail.com','hyderabad','cNVCG7');
...
insert  into `total_units`(`id`,`blood_group`,`no_of_units`) values (1,'A ','13'),(2,'B+','45');
